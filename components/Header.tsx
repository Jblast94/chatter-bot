...
export default function Header() {
  const { showUserConfig, setShowUserConfig, setShowAgentEdit, setShowChatAssistant, showChatAssistant } = useUI();
  const { name } = useUser();
  ...
  return (
    <header>
      ...
      <div className="header-right">
        <button
          className={c("assistant-toggle", { active: showChatAssistant })}
